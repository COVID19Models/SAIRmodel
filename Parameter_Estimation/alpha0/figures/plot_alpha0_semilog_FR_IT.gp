...
set output 'I_vs_time_early_FR_IT.eps'
set bmargin 8
set lmargin 17
...
plot       "I_run_av_7_FR.data"    every 2 using  1:(log($2))       with points pt 7 ps 3 lw 6 lc 8 dt 1  title 'France: {/Symbol a_0} = 0.280 ' ,\
           "I_run_av_7_IT.data"    every 2 using  1:(log($2))       with points pt 4 ps 3 lw 6 lc 8 dt 1  title 'Italy: {/Symbol a_0} = 0.256' ,\
