...
plot       "I_run_av_7_FR.data"    every 2         using  1:(log($3+$2*gamma1))       with points pt 7 ps 3 lw 4 lc 8 dt 1  title 'France: {/Symbol b}_1 =  0.007' ,\
           "I_run_av_7_SW.data"    every 4         using  1:(log($3+$2*gamma4))       with points pt 6 ps 3 lw 4 lc 8 dt 1  title 'Switzerland: {/Symbol b}_1 =  0.05' ,\
